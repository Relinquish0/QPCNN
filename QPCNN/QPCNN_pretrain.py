...
class HyperParameters:
    def __init__(self, date, hour, min):#!!You need to fill in the address of the file where the neural network is located
        self.save_path = 'C:/Users/86136/Desktop/QPCNN'# Output data saving path
        ...
        self.data_train = '{}/Data_train_uncorrelated.npy'.format(self.save_path)
        self.data_test = '{}/Data_test_uncorrelated.npy'.format(self.save_path)
        self.data_infer = '{}/Data_infer_uncorrelated.npy'.format(self.save_path)
